                ...
                <div class="page-heading">
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Questions Management
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <section class="section">
                        <div class="card">
                            ...
                            <div class="modal fade text-left" id="addQuestionModal" tabindex="-1" role="dialog"
                                aria-labelledby="myAddQuestionsModal" aria-hidden="true">
                                            ...
                                            <form class="form" data-parsley-validate enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    <div class="form-group mandatory mb-3">
                                                        <label for="category-id" class="form-label">Related
                                                            Categories</label>
